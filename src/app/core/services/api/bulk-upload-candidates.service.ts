...
export class BulkUploadCandidatesService {
 ...
 private baseUrl = 'https://recruitx20250704121717-fdb4cqaze6bsgcfr.canadacentral-01.azurewebsites.net/api/JobDescription/my-job-descriptions'; // Adjust base URL as needed
