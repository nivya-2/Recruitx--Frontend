...
export class EmailTemplateServiceService {
  ...
  getGroupedEmailTemplates(): Observable<ApiResponse<Record<string, EmailTemplate[]>>> {
  return this.http.get<ApiResponse<EmailTemplate[]>>(this.apiUrl).pipe(
    map((response) => {
      ...
      const groupedResponse: ApiResponse<Record<string, EmailTemplate[]>> = {
        statusCode: response.statusCode,
        message: 'Grouped templates fetched successfully',
        data: grouped,
        meta: response.meta // optional
      };
